...
"""
    ...
    #total_score = sum(result)
    fw = xx.forward_messages(group_id, group_id4, response)
    fw2 = xx.forward_messages(group_id, group_id4, response2)
    fw3 = xx.forward_messages(group_id, group_id4, response3)
    fw4 = xx.forward_messages(channel_id, group_id4, [response, response2, response3])
